...
my $radio_trims = UAV::Pilot::Wumpus::PacketFactory->fresh_packet(
    'RadioTrims' );
...
my $radio_max = UAV::Pilot::Wumpus::PacketFactory->fresh_packet(
    'RadioMaxes' );
...
my $radio_min = UAV::Pilot::Wumpus::PacketFactory->fresh_packet(
    'RadioMins' );
$radio_min->ch1_min( 0 );
$radio_min->ch2_min( 0 );
